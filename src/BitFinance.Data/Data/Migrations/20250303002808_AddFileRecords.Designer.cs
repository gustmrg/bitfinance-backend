...
namespace BitFinance.Data.Data.Migrations
{
    ...
    [Migration("20250303002808_AddFileRecords")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BitFinance.Business.Entities.FileRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("BillId")
                        .HasDatabaseName("ix_file_records_bill_id");
            ...
            modelBuilder.Entity("BitFinance.Business.Entities.FileRecord", b =>
                {
                    b.HasOne("BitFinance.Business.Entities.Bill", "Bill")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_file_records_bills_bill_id");
